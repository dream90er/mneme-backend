package net.ddns.la90zy.mneme;

import net.ddns.la90zy.mneme.syncservice.control.HostProviderService;
import net.ddns.la90zy.mneme.syncservice.control.UserService;
import net.ddns.la90zy.mneme.syncservice.control.HostProviderClientServiceFactory;
...
public class DatabaseBootstrapBean {
    ...
    @Inject
    @ConfigProperty(name = "net.ddns.la90zy.mneme.defaultadminlogin",
            defaultValue = "admin")
    private String defaultAdminLogin;

    @Inject
    @ConfigProperty(name = "net.ddns.la90zy.mneme.defaultadminpassword",
            defaultValue = "admin")
